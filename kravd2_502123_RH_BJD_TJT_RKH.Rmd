...
```{r}
male_filter <- filter(hgt_sim, sex == 'male')
mu_male <- mean(male_filter$hgt)
pnorm(180, mu_male, 2) - pnorm(170, mu_male, 2)

female_filter <- filter(hgt_sim, sex == 'female')
mu_female <- mean(female_filter$hgt)
pnorm(180, mu_female, 2) - pnorm(170, mu_female,2)
```
